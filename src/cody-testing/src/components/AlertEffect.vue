<template>
    <div>
        ...
        <div class="flex items-center justify-between">
            ...
            <p class="text-sm"><strong>Success:</strong> this is a success message.</p>
            </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <p class="text-sm"><strong>Error:</strong> this is an error message.</p>
            </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <p class="text-sm"><strong>Warning:</strong> this is a warning message.</p>
            </div>
