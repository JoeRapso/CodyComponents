<template>
    <div>
              <!-- "dynamicClass", invokes one of the alert theme classes based on a conditional.
                    "visible" is a data property containing a class that makes the alert visible and turns
                    to null if the alert closed button is clicked, hiding the alert.
                    
                    The button element has 3 functions when the alert box closes(hides)
                    "successAlertClosed(), errorAlertClosed() and warningAlertClosed()"
                    they emit a message based on a conditional
                    
                    at the end of the styling block down below I have commented out additional
                    css classes that I got from looking at the dev tools at the cody site for the alert
                    they are the classes that make the alert box colored or not, the css classes provided
                    by the alert source code on the codyhouse site do not color the alert boxes as far as I can tell -->
...
/* color blocks, not provided from cody source code - they make the alert boxes colored
.x-nkq {
